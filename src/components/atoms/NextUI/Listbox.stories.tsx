...
const PullRequestIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
...
const TagIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <circle r="1.647" cx="8.353" cy="8.353" fill="currentColor" />
  </svg>
);
...
const WatchersIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
...
const Template = ({ color, variant, ...args }: ListboxProps) => (
  ...
  >
    ...
    <ListboxItem key="delete" color="danger" className="text-danger">
      Delete file
    </ListboxItem>
  </Listbox>
);
...
const MultipleSelectionTemplate = ({
  ...
  return (
    <Listbox
      ...
      onSelectionChange={(key) => setSelected(key as Set<string>)}
      {...args}
    >
      <ListboxItem key="text">Text</ListboxItem>
      <ListboxItem key="number">Number</ListboxItem>
...
const WithBottomContentTemplate = ({
  color,
  ...args
}: ListboxProps<{
  id: number;
...
const CustomWithClassNamesTemplate = ({
  ...
  const IconWrapper = ({
    ...
    <div
      className={clsx(
        className,
        "flex size-7 items-center justify-center rounded-small"
      )}
    >
      {children}
    </div>
